...
server.tool("search_movies", "Search for movies using the TMDB API", {
...
server.tool("get_trending_movies", "Get the top trending movies of the day", {}, // Note: This tool doesn't require the AI to provide any input!
async () => {
...
server.tool("get_movie_details", "Get detailed information about a specific movie (runtime, rating, genres)", {
...
server.tool("get_movie_recommendations", "Get a list of recommended movies based on a specific movie", {
